...
public class MomSelfdiagnosisActivity6 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mom_selfdiagnosis6);
        ...
        Button30.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View w) {
                Intent intent = new Intent(getApplicationContext(), MomSelfdiagnosisActivity7.class);
                startActivity(intent);
            }
        });
