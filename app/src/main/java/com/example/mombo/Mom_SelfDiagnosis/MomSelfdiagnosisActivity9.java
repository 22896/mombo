...
public class MomSelfdiagnosisActivity9 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mom_selfdiagnosis9);
        ...
        Button30.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View w) {
                Intent intent = new Intent(getApplicationContext(), MomSelfdiagnosisActivity10.class);
                startActivity(intent);
            }
        });
    }
