...
//        mDisplayNameTV = (TextView) findViewById(R.id.display_name_text);
...
//        if(currentUser == null){
//            Intent signinScreenIntent = new Intent(this, talk.class);
...
//                            Toast.makeText(talk.this, "Message sending failed", Toast.LENGTH_SHORT).show();
//                        }else{
//                            mMessageET.setText("");
//                        }
//                    }
