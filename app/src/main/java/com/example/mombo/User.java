...
public class User {
    ...
    public User(String id, String name, String email, String password, String phone, String friend_phone, String message, String token, String notification, String walk, String hnumber, String gender) {
        this.id = id;
        this.name = name;
        this.email = email;
