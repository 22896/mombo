...
public class JoinFamActivity extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                if ((email != null && !email.isEmpty()) && (pswd != null && !pswd.isEmpty())
                    ...
                    mAuth.createUserWithEmailAndPassword(email, pswd)
                            .addOnCompleteListener(JoinFamActivity.this, new OnCompleteListener<AuthResult>() {
                                @Override
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Toast.makeText(JoinFamActivity.this, "등록 성공!", Toast.LENGTH_SHORT).show();

                                        Intent intent = new Intent(JoinFamActivity.this, LoginActivity.class);
                                        startActivity(intent);

                                    } else {
                                        Toast.makeText(JoinFamActivity.this, "비밀번호는 문자와 숫자 혼합으로 6자리 이상 지정해주세요.", Toast.LENGTH_SHORT).show();
                                    }
                    ...
                    Toast.makeText(JoinFamActivity.this, "회원가입 실패!", Toast.LENGTH_SHORT).show();
                }
